package net.smoothplugins.paper.menu.manager;

import net.smoothplugins.paper.menu.listener.InventoryClickListener;
import net.smoothplugins.paper.menu.listener.InventoryCloseListener;
